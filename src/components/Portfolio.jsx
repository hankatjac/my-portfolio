    ...
    <div id="portfolio">
      <div className="container-fluid">
        <div className="row gap-1">
          <div className="col-lg-4 col-sm-6  text-center border border-5 border-primary">
            <a
              className="portfolio-box"
              href="https://www.exel-tech.com"
              target="_blank"
              title="Project Name"
            >
              <img
                className="img-fluid"
                src={require("../assets/img/portfolio/thumbnails/1.png")}
                alt="..."
              />
          ...
          <div className="col-lg-4 col-sm-6  text-center border border-5 border-primary">
            <a
              className="portfolio-box"
              href="https://hankatjac.github.io/strapi-cloudinary-store-client"
              target="_blank"
              title="Project Name"
            >
              <img
                className="img-fluid"
                src={require("../assets/img/portfolio/thumbnails/8.png")}
                alt="..."
              />
              <div className="portfolio-box-caption">
                <div className="project-category text-white-50">Category</div>
          ...
          <div className="col-lg-4 col-sm-6  text-center border border-5 border-primary">
            ...
            >
              <img
                className="img-fluid"
                src={require("../assets/img/portfolio/thumbnails/7.png")}
                alt="..."
              />
              <div className="portfolio-box-caption">
                <div className="project-category text-white-50">Category</div>
